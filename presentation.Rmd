...
- Largest and most diverse bird order
...
.pull-right[
```{r Passeriformes1, echo = FALSE, out.width = "150%", fig.align = "center", fig.cap = "Source: @Richad?"}
...
.pull-left[
 ...
 - Worked with the species‐average data set
...
- Birds in open habitats are lighter on average
...
.pull-left[
 ...
 - Both habitats show a right-skewed distribution


 - Similar mass range (5–1000 g)


  - Higher frequency of some smaller birds compared with open habitats


 - Similar IQRs, though open habitats have a slightly smaller middle-spread.


 - Open habitats show a wider spread of outliers
...
.pull-left[
```{r Fitted model w multiple varibles, echo = FALSE, out.width = "55%"}
